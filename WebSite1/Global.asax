...
<script RunAt="server">
    ...
    public static void RegisterRoutes(RouteCollection routes) {
        ...
        {
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)new chemdbEntities()).ObjectContext;
        }, new ContextConfiguration() { ScaffoldAllTables = true });
            
        // The following registration should be used if YourDataContextType does not derive from DbContext
        //DefaultModel.RegisterContext(typeof(masterEntities), new ContextConfiguration() { ScaffoldAllTables = true });
